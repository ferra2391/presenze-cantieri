...
const operai = {
  "mata": "max321", "pata": "pasq@85", "maez": "maja44", "saac": "sam!90",
  "oot": "teo007", "emma": "manu12", "maro": "ronco33", "kero": "kevx88",
  "ahaz": "zrik77", "abaq": "aziz@19", "maru": "matt34", "guha": "gus123", "gigr": "giox55"
};
...
function aggiungiCantiere() {
  ...
  if (nuovo) {
    fetch(API_URL, {
      ...
      alert(`Cantiere "${nuovo}" inviato a Google Sheet.`);
    });
  }
}
